...
<ul role="navigation" id="adminmenu">
	...
	<li id="menu-posts" class="wp-has-submenu wp-has-current-submenu wp-menu-open open-if-no-js menu-top menu-icon-post menu-top-first">
		...
		<li class="wp-first-item <?php if('list_post' == $curNav) echo 'current'; ?>"><a class="wp-first-item current" href="edit.php">All Posts</a></li>
		<li class="<?php if('add_post' == $curNav) echo 'current'; ?>"><a href="post-new.php"  ><?php //echo $curNav; ?>Add New</a></li>
